...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CAdaptiveMusicClientPlugin, IServerPluginCallbacks, INTERFACEVERSION_ISERVERPLUGINCALLBACKS, g_AdaptiveMusicClientPlugin);
...
//---------------------------------------------------------------------------------
PLUGIN_RESULT CAdaptiveMusicClientPlugin::ClientConnect(bool *bAllowConnect, edict_t *pEntity, const char *pszName, const char *pszAddress, char *reject, int maxrejectlen)
{
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicClientPlugin::OnQueryCvarValueFinished(QueryCvarCookie_t iCookie, edict_t *pPlayerEntity, EQueryCvarValueStatus eStatus, const char *pCvarName, const char *pCvarValue)
{
