...
#endif
//---------------------------------------------------------------------------------
// Purpose: AdaptiveMusic Server Plugin
//---------------------------------------------------------------------------------
class CAdaptiveMusicServerPlugin : public IServerPluginCallbacks, public IGameEventListener
{
public:
	CAdaptiveMusicServerPlugin();
	~CAdaptiveMusicServerPlugin();
...
//
CAdaptiveMusicServerPlugin g_AdaptiveMusicServerPlugin;
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CAdaptiveMusicServerPlugin, IServerPluginCallbacks, INTERFACEVERSION_ISERVERPLUGINCALLBACKS, g_AdaptiveMusicServerPlugin);

//---------------------------------------------------------------------------------
// Purpose: constructor/destructor
//---------------------------------------------------------------------------------
CAdaptiveMusicServerPlugin::CAdaptiveMusicServerPlugin()
{
...
//---------------------------------------------------------------------------------
bool CAdaptiveMusicServerPlugin::Load(CreateInterfaceFn interfaceFactory, CreateInterfaceFn gameServerFactory)
{
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::Unload(void)
{
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::Pause(void)
{
}
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::UnPause(void)
{
}
...
//---------------------------------------------------------------------------------
const char *CAdaptiveMusicServerPlugin::GetPluginDescription(void)
{
	return "AdaptiveMusic Server Plugin, Manuel Russello";
}

//---------------------------------------------------------------------------------
// Purpose: called on level start
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::LevelInit(char const *pMapName)
{
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::ServerActivate(edict_t *pEdictList, int edictCount, int clientMax)
{
}
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::GameFrame(bool simulating)
{
	if (simulating)
	{
	}
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::LevelShutdown(void) // !!!!this can get called multiple times per map change
{
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::ClientActive(edict_t *pEntity)
{
}
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::ClientDisconnect(edict_t *pEntity)
{
}
...
// Purpose: called on level start
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::SetCommandClient(int index)
{
...
// Purpose: called on level start
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::ClientSettingsChanged(edict_t *pEdict)
{
	if (playerinfomanager)
	{
...
//---------------------------------------------------------------------------------
PLUGIN_RESULT CAdaptiveMusicServerPlugin::ClientConnect(bool *bAllowConnect, edict_t *pEntity, const char *pszName, const char *pszAddress, char *reject, int maxrejectlen)
{
...
CON_COMMAND( DoAskConnect, "Server plugin example of using the ask connect dialog" )
{
	...
	else
	{
		...
		for ( int i=1; i < gpGlobals->maxClients; i++ )
		{
			...
			if ( pEdict )
			{
				helpers->CreateMessage( pEdict, DIALOG_ASKCONNECT, kv, &g_AdaptiveMusicServerPlugin );
			}
		}
...
PLUGIN_RESULT CAdaptiveMusicServerPlugin::ClientCommand(edict_t *pEntity, const CCommand &args)
{
	/*
...
//---------------------------------------------------------------------------------
PLUGIN_RESULT CAdaptiveMusicServerPlugin::NetworkIDValidated(const char *pszUserName, const char *pszNetworkID)
{
	return PLUGIN_CONTINUE;
}
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::OnQueryCvarValueFinished(QueryCvarCookie_t iCookie, edict_t *pPlayerEntity, EQueryCvarValueStatus eStatus, const char *pCvarName, const char *pCvarValue)
{
	// Msg( "Cvar query (cookie: %d, status: %d) - name: %s, value: %s\n", iCookie, eStatus, pCvarName, pCvarValue );
}
void CAdaptiveMusicServerPlugin::OnEdictAllocated(edict_t *edict)
{
}
void CAdaptiveMusicServerPlugin::OnEdictFreed(const edict_t *edict)
{
}
...
//---------------------------------------------------------------------------------
void CAdaptiveMusicServerPlugin::FireGameEvent(KeyValues *event)
{
	const char *name = event->GetName();
	Msg("CAdaptiveMusicServerPlugin::FireGameEvent: Got event \"%s\"\n", name);
}

//---------------------------------------------------------------------------------
// Purpose: an example of how to implement a new command
//---------------------------------------------------------------------------------
CON_COMMAND(AM_SP_version, "Prints the version of the AdaptiveMusic server plugin")
{
	Msg("AdaptiveMusic Server Plugin v0.0.1\n");
}
